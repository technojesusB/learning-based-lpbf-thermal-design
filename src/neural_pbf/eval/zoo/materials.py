...
class MaterialZoo:
    ...
    def register(
        ...
        self._registry[name] = ZooEntry(name=name, mat_cfg=mat_cfg, in_distribution=in_distribution)
    ...
    def default(cls) -> MaterialZoo:
        ...
        zoo.register("alsi10mg", MaterialConfig.alsi10mg_preset(), in_distribution=False)
