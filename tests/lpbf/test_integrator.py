...
def mat_config():
    return MaterialConfig(
        k_powder=1.0, k_solid=1.0, k_liquid=1.0,
        cp_base=1.0, rho=1.0,
        T_solidus=1000.0, T_liquidus=1100.0,
        latent_heat_L=100.0
    )
...
def test_adaptive_stability(sim_config, mat_config):
    ...
    sim_unstable = sim_config.model_copy(update={
    ...
    sim_custom = SimulationConfig(
         Lx=1.0, Ly=1.0, Nx=20, Ny=20, Nz=1,
